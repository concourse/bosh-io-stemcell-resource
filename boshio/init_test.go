...
var _ = BeforeEach(func() {
	...
	s3Backend.PutObject("bucket_name", "path/to/bosh-stemcell-1.1332-aws-xen-hvm-ubuntu-jammy-fips-go_agent.tgz", map[string]string{"Last-Modified": "Mon, 2 Jan 2006 15:04:05 GMT"}, strings.NewReader("private fips stemcell content"), 29, nil)
	s3Backend.PutObject("bucket_name", "path/to/bosh-stemcell-1.1333-google-kvm-ubuntu-jammy-fips-go_agent.tgz", map[string]string{"Last-Modified": "Mon, 2 Jan 2006 15:04:05 GMT"}, strings.NewReader("private google fips stemcell"), 27, nil)
	boshioServer = &server{
		mux:                     router,
